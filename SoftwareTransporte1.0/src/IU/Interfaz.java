...
public class Interfaz {
	...
	public void imprimirMenu() {
		...
		System.out.println("1.Ingresar Producto al Almacen ");
		System.out.println("2.Ver Almacen de Productos");
		System.out.println("3.Buscar Productos en el Alamcen");
	...
	public void AgregarProducto() {
		...
		autoparte.setId_producto(entrada.next());
		 if(almacen.add(autoparte)== true) {
			 System.out.println("\nSe agrego correctamente la Autoparte\n");
		 }else {
		 ...
		 private void menuAlter(Autoparte autoparte) {
				...
				case 1: QuitarProducto(autoparte);
					break;
				case 2: EditarProducto(autoparte);
					break;
				case 3: imprimirMenu();
					break;
					default: System.out.println("Se eligio una opción incorrecta volver a intentar");
		 ...
		 public void EditarProducto(Autoparte autoparte) {
